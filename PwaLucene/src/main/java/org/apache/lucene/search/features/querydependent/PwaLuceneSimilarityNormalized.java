...
public class PwaLuceneSimilarityNormalized implements PwaIRankingFunction {
	...
	private final static float MAX_SCORE=56; // max score within 1000 queries extracted from query logs and submitted to the system
	private float score;
	private PwaLuceneSimilarity similarity;
