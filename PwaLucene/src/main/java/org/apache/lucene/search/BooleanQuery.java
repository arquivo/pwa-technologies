...
public class BooleanQuery extends Query {
  ...
  /** functions and boots for scorer */
  private PwaFunctionsWritable functions = null;  
  ...
  public void setFunctions(PwaFunctionsWritable functions) {
	  this.functions=functions;
  }
  
  public PwaFunctionsWritable getFunctions() {
	  return functions;
  }
  ...
  private class PwaWeight extends BooleanWeight2 {
     ...
     *          and scores documents in document number order.
     */
    public PwaScorer scorer(IndexReader reader) throws IOException {
    	return new PwaScorer(BooleanQuery.this,searcher,reader,functions);    	
    }
    
    public Explanation explain(IndexReader reader, int doc) throws IOException {
    	return (new PwaScorer(BooleanQuery.this,searcher,reader,functions)).explain(doc);   	
	}
  }
  ...
  public Query rewrite(IndexReader reader) throws IOException {
	...
	// to guaranty that no clause is rewritten to a TermQuery like when a exacturl occurs alone
