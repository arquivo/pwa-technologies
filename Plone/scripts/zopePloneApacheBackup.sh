...
FILES="$PLONE_DIR/zinstance/var/Data.fs $PLONE_DIR/zinstance/lib/python/plone/app/i18n/locales/browser/ $PLONE_DIR/zinstance/lib/python/plone/app/layout/viewlets/ \
       ...
       /home/plone/Plone-3.0.5/lib/python/ZServer/HTTPResponse.py /root/scripts/ /home/plone/Plone-3.0.5/zinstance/log/ /var/log/httpd/ /var/log/logfile.1261440000 \
       /etc/awstats/awstats.arquivo-web.fccn.pt.conf"
...
tar -cPzpf $BACKUP_DIR/zopePloneApache.tar.gz $FILES
