...
public interface HttpHeaderProcessor {
	...
	public final static String HTTP_LOCATION_HEADER_UP = HTTP_LOCATION_HEADER.toUpperCase();

	public final static String HTTP_CONTENT_BASE_HEADER = "Content-Base";
	public final static String HTTP_CONTENT_BASE_HEADER_UP = HTTP_CONTENT_BASE_HEADER.toUpperCase();

	public final static String HTTP_CONTENT_TYPE_HEADER = "Content-Type";
	public final static String HTTP_CONTENT_TYPE_HEADER_UP = HTTP_CONTENT_TYPE_HEADER.toUpperCase();
	
	public final static String HTTP_TRANSFER_ENC_HEADER = "Transfer-Encoding";
	public final static String HTTP_TRANSFER_ENC_HEADER_UP = "Transfer-Encoding".toUpperCase();
