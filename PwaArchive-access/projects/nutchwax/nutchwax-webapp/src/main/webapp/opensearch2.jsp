...
<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/"
	...
	<Url type="application/rss+xml" method="get" template="<c:out value="${rootUrl}"/>/opensearch2?query={searchTerms}&amp;dtstart={time:start?}&amp;dtend={time:end?}"/>
        <Url type="application/opensearchdescription+xml" rel="self" template="<c:out value="${rootUrl}"/>/opensearch2.jsp" />
