...
class Select {
    ...
    getLabel() {
        return __chunk_7.findItemLabel(this.el);
    }
    hasValue() {
        return this.getText() !== '';
    }
    ...
    render() {
        ...
        __chunk_7.renderHiddenInput(true, el, name, parseValue(value), disabled);
...
class SelectOption {
    constructor(hostRef) {
         ...
         */
        this.selected = false;
        this.ionSelectOptionDidLoad = __chunk_1.createEvent(this, "ionSelectOptionDidLoad", 7);
        this.ionSelectOptionDidUnload = __chunk_1.createEvent(this, "ionSelectOptionDidUnload", 7);
    }
    componentWillLoad() {
        if (this.value === undefined) {
