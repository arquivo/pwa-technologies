...
const patchBrowser = async () => {
    // @ts-ignore
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('chunk-db9737a7.js', document.baseURI).href));
    if (importMeta !== '') {
    ...
    if ( (hostRef.$flags$ & 256 /* hasInitializedComponent */) === 0) {
        ...
        if ( !Cstr.isStyleRegistered && Cstr.style) {
            ...
            if ( cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await new Promise(function (resolve) { resolve(require('./shadow-css-984bac74-35c6f7da.js')); }).then(m => m.scopeCss(style, scopeId, false));
            }
