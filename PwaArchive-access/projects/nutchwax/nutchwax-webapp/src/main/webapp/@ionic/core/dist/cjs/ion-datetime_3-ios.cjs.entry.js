...
class Datetime {
    ...
    async open() {
        ...
        const picker = await __chunk_4.pickerController.create(pickerOptions);
    ...
    async validateColumn(picker, name, index, min, max, lowerBounds, upperBounds) {
        ...
        const selectedIndex = column.selectedIndex = __chunk_7.clamp(indexMin, column.selectedIndex, indexMax);
    ...
    render() {
        ...
        __chunk_7.renderHiddenInput(true, el, this.name, this.value, this.disabled);
        return (__chunk_1.h(__chunk_1.Host, { onClick: this.onClick, role: "combobox", "aria-disabled": disabled ? 'true' : null, "aria-expanded": `${isExpanded}`, "aria-haspopup": "true", "aria-labelledby": labelId, class: {
                [mode]: true,
                'datetime-disabled': disabled,
                'datetime-readonly': readonly,
                'datetime-placeholder': addPlaceholderClass,
                'in-item': __chunk_5.hostContext('ion-item', el)
            } }, __chunk_1.h("div", { class: "datetime-text" }, datetimeText), __chunk_1.h("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: this.disabled, ref: btnEl => this.buttonEl = btnEl })));
    }
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({ [mode]: true,
                ...
                [`picker-${mode}`]: true }, __chunk_5.getClassMap(this.cssClass)),
            style: {
...
function buttonClass(button) {
    return Object.assign({ 'picker-button': true, 'ion-activatable': true }, __chunk_5.getClassMap(button.cssClass));
}
...
class PickerColumnCmp {
    constructor(hostRef) {
        ...
        this.y = 0;
        this.noAnimate = true;
        this.ionPickerColChange = __chunk_1.createEvent(this, "ionPickerColChange", 7);
    }
    colChanged() {
        this.refresh();
    }
    ...
    onEnd(detail) {
        ...
        this.velocity = __chunk_7.clamp(-MAX_PICKER_SPEED, detail.velocityY * 23, MAX_PICKER_SPEED);
    ...
    refresh(forceRefresh) {
        ...
        const selectedIndex = __chunk_7.clamp(min, this.col.selectedIndex || 0, max);
    ...
    __stencil_render() {
        ...
        const Button = 'button';
        return [
            col.prefix && (__chunk_1.h("div", { class: "picker-prefix", style: { width: col.prefixWidth } }, col.prefix)),
            __chunk_1.h("div", { class: "picker-opts", style: { maxWidth: col.optionsWidth }, ref: el => this.optsEl = el }, col.options.map((o, index) => __chunk_1.h(Button, { type: "button", class: { 'picker-opt': true, 'picker-opt-disabled': !!o.disabled }, "opt-index": index }, o.text))),
            col.suffix && (__chunk_1.h("div", { class: "picker-suffix", style: { width: col.suffixWidth } }, col.suffix))
        ];
    }
    get el() { return __chunk_1.getElement(this); }
    static get watchers() { return {
