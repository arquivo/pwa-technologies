...
class Slide {
    constructor(hostRef) {
        ...
        this.ionSlideChanged = __chunk_1.createEvent(this, "ionSlideChanged", 7);
    }
    componentDidLoad() {
...
class Slides {
    constructor(hostRef) {
        ...
        this.ionSlidesDidLoad = __chunk_1.createEvent(this, "ionSlidesDidLoad", 7);
        this.ionSlideTap = __chunk_1.createEvent(this, "ionSlideTap", 7);
        this.ionSlideDoubleTap = __chunk_1.createEvent(this, "ionSlideDoubleTap", 7);
        this.ionSlideWillChange = __chunk_1.createEvent(this, "ionSlideWillChange", 7);
        this.ionSlideDidChange = __chunk_1.createEvent(this, "ionSlideDidChange", 7);
        this.ionSlideNextStart = __chunk_1.createEvent(this, "ionSlideNextStart", 7);
        this.ionSlidePrevStart = __chunk_1.createEvent(this, "ionSlidePrevStart", 7);
        this.ionSlideNextEnd = __chunk_1.createEvent(this, "ionSlideNextEnd", 7);
        this.ionSlidePrevEnd = __chunk_1.createEvent(this, "ionSlidePrevEnd", 7);
        this.ionSlideTransitionStart = __chunk_1.createEvent(this, "ionSlideTransitionStart", 7);
        this.ionSlideTransitionEnd = __chunk_1.createEvent(this, "ionSlideTransitionEnd", 7);
        this.ionSlideDrag = __chunk_1.createEvent(this, "ionSlideDrag", 7);
        this.ionSlideReachStart = __chunk_1.createEvent(this, "ionSlideReachStart", 7);
        this.ionSlideReachEnd = __chunk_1.createEvent(this, "ionSlideReachEnd", 7);
        this.ionSlideTouchStart = __chunk_1.createEvent(this, "ionSlideTouchStart", 7);
        this.ionSlideTouchEnd = __chunk_1.createEvent(this, "ionSlideTouchEnd", 7);
    }
    ...
    async initSwiper() {
        ...
        // init swiper core
        // @ts-ignore
        const { Swiper } = await new Promise(function (resolve) { resolve(require('./swiper.bundle-ff4511ef.js')); });
    ...
    __stencil_render() {
        return [
            __chunk_1.h("div", { class: "swiper-wrapper" }, __chunk_1.h("slot", null)),
            this.pager && __chunk_1.h("div", { class: "swiper-pagination", ref: el => this.paginationEl = el }),
            this.scrollbar && __chunk_1.h("div", { class: "swiper-scrollbar", ref: el => this.scrollbarEl = el })
        ];
    }
