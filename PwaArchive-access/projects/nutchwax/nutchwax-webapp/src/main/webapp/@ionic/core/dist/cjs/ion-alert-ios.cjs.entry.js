...
class Alert {
    constructor(hostRef) {
         ...
         */
        this.animated = true;
        this.didPresent = __chunk_1.createEvent(this, "ionAlertDidPresent", 7);
        this.willPresent = __chunk_1.createEvent(this, "ionAlertWillPresent", 7);
        this.willDismiss = __chunk_1.createEvent(this, "ionAlertWillDismiss", 7);
        this.didDismiss = __chunk_1.createEvent(this, "ionAlertDidDismiss", 7);
    }
    buttonsChanged() {
     ...
     */
    present() {
        return __chunk_4.present(this, 'alertEnter', iosEnterAnimation, mdEnterAnimation);
    }
    /**
     ...
     */
    dismiss(data, role) {
        return __chunk_4.dismiss(this, data, role, 'alertLeave', iosLeaveAnimation, mdLeaveAnimation);
    }
    /**
     * Returns a promise that resolves when the alert did dismiss.
     */
    onDidDismiss() {
        return __chunk_4.eventMethod(this.el, 'ionAlertDidDismiss');
    }
    /**
     * Returns a promise that resolves when the alert will dismiss.
     */
    onWillDismiss() {
        return __chunk_4.eventMethod(this.el, 'ionAlertWillDismiss');
    }
    ...
    renderCheckbox(labelledby) {
        ...
        return (__chunk_1.h("div", { class: "alert-checkbox-group", "aria-labelledby": labelledby }, inputs.map(i => (__chunk_1.h("button", { type: "button", onClick: () => this.cbClick(i), "aria-checked": `${i.checked}`, id: i.id, disabled: i.disabled, tabIndex: 0, role: "checkbox", class: "alert-tappable alert-checkbox alert-checkbox-button ion-focusable" }, __chunk_1.h("div", { class: "alert-button-inner" }, __chunk_1.h("div", { class: "alert-checkbox-icon" }, __chunk_1.h("div", { class: "alert-checkbox-inner" })), __chunk_1.h("div", { class: "alert-checkbox-label" }, i.label)), mode === 'md' && __chunk_1.h("ion-ripple-effect", null))))));
    }
    renderRadio(labelledby) {
        ...
        return (__chunk_1.h("div", { class: "alert-radio-group", role: "radiogroup", "aria-labelledby": labelledby, "aria-activedescendant": this.activeId }, inputs.map(i => (__chunk_1.h("button", { type: "button", onClick: () => this.rbClick(i), "aria-checked": `${i.checked}`, disabled: i.disabled, id: i.id, tabIndex: 0, class: "alert-radio-button alert-tappable alert-radio ion-focusable", role: "radio" }, __chunk_1.h("div", { class: "alert-button-inner" }, __chunk_1.h("div", { class: "alert-radio-icon" }, __chunk_1.h("div", { class: "alert-radio-inner" })), __chunk_1.h("div", { class: "alert-radio-label" }, i.label)))))));
    }
    renderInput(labelledby) {
        ...
        return (__chunk_1.h("div", { class: "alert-input-group", "aria-labelledby": labelledby }, inputs.map(i => (__chunk_1.h("div", { class: "alert-input-wrapper" }, __chunk_1.h("input", { placeholder: i.placeholder, value: i.value, type: i.type, min: i.min, max: i.max, onInput: e => i.value = e.target.value, id: i.id, disabled: i.disabled, tabIndex: 0, class: "alert-input" }))))));
    }
    hostData() {
        const mode = __chunk_1.getIonMode(this);
        return {
            ...
            class: Object.assign({}, __chunk_5.getClassMap(this.cssClass), { [mode]: true, 'alert-translucent': this.translucent })
        };
    }
    renderAlertButtons() {
        ...
        return (__chunk_1.h("div", { class: alertButtonGroupClass }, buttons.map(button => __chunk_1.h("button", { type: "button", class: buttonClass(button), tabIndex: 0, onClick: () => this.buttonClick(button) }, __chunk_1.h("span", { class: "alert-button-inner" }, button.text), mode === 'md' && __chunk_1.h("ion-ripple-effect", null)))));
    }
    __stencil_render() {
        ...
        return [
            ...
            __chunk_1.h("div", { class: "alert-wrapper" }, __chunk_1.h("div", { class: "alert-head" }, this.header && __chunk_1.h("h2", { id: hdrId, class: "alert-title" }, this.header), this.subHeader && __chunk_1.h("h2", { id: subHdrId, class: "alert-sub-title" }, this.subHeader)), __chunk_1.h("div", { id: msgId, class: "alert-message", innerHTML: __chunk_8.sanitizeDOMString(this.message) }), this.renderAlertInputs(labelledById), this.renderAlertButtons())
        ];
    }
...
function buttonClass(button) {
    return Object.assign({ 'alert-button': true, 'ion-focusable': true, 'ion-activatable': true }, __chunk_5.getClassMap(button.cssClass));
}
