...
class Fab {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { onClick: this.onClick, class: {
                [mode]: true,
...
class FabButton {
    ...
    __stencil_render() {
        ...
        return (__chunk_1.h(TagType, Object.assign({}, attrs, { class: "button-native", disabled: this.disabled, onFocus: this.onFocus, onBlur: this.onBlur, onClick: (ev) => __chunk_5.openURL(this.href, ev, this.routerDirection) }), __chunk_1.h("span", { class: "close-icon" }, __chunk_1.h("ion-icon", { name: "close", lazy: false })), __chunk_1.h("span", { class: "button-inner" }, __chunk_1.h("slot", null)), mode === 'md' && __chunk_1.h("ion-ripple-effect", null)));
    }
    get el() { return __chunk_1.getElement(this); }
