...
class r {
    constructor(t) {
        i(this, t),
        this.ionSlideChanged=e(this, "ionSlideChanged", 7)
    }
    componentDidLoad() {
    ...
    hostData() {
        return {
            class: {
                [t(this)]: !0, "swiper-slide": !0, "swiper-zoom-container": !0
            }
        }
    }
    render() {
        return s(n, this.hostData())
    }
    static get style() {
        return""
    }
...
class l {
    constructor(t) {
        ...
        this.pager=!1,
        this.scrollbar=!1,
        this.ionSlidesDidLoad=e(this, "ionSlidesDidLoad", 7),
        this.ionSlideTap=e(this, "ionSlideTap", 7),
        this.ionSlideDoubleTap=e(this, "ionSlideDoubleTap", 7),
        this.ionSlideWillChange=e(this, "ionSlideWillChange", 7),
        this.ionSlideDidChange=e(this, "ionSlideDidChange", 7),
        this.ionSlideNextStart=e(this, "ionSlideNextStart", 7),
        this.ionSlidePrevStart=e(this, "ionSlidePrevStart", 7),
        this.ionSlideNextEnd=e(this, "ionSlideNextEnd", 7),
        this.ionSlidePrevEnd=e(this, "ionSlidePrevEnd", 7),
        this.ionSlideTransitionStart=e(this, "ionSlideTransitionStart", 7),
        this.ionSlideTransitionEnd=e(this, "ionSlideTransitionEnd", 7),
        this.ionSlideDrag=e(this, "ionSlideDrag", 7),
        this.ionSlideReachStart=e(this, "ionSlideReachStart", 7),
        this.ionSlideReachEnd=e(this, "ionSlideReachEnd", 7),
        this.ionSlideTouchStart=e(this, "ionSlideTouchStart", 7),
        this.ionSlideTouchEnd=e(this, "ionSlideTouchEnd", 7)
    }
    ...
    onSlideChanged() {
        this.didInit&&this.update()
    }
    async update() {
        (await this.getSwiper()).update()
    }
    ...
    async initSwiper() {
        ...
        =await __sc_import_ionic("./p-a0ff558a.js"),
        t=new e(this.el, i);
        this.didInit=!0,
        this.readySwiper(t)
    }
    ...
    normalizeOptions() {
        const i= {
            ...
            setWrapperSize:!1,
            zoom: {
                maxRatio: 3, minRatio: 1, toggle: !1
            }
            ,
            touchRatio:1,
            touchAngle:45,
        ...
        this.pager&&(i.pagination= {
            el: this.paginationEl, type: "bullets", clickable: !1, hideOnClick: !1
        }
        ),
        this.scrollbar&&(i.scrollbar= {
            el: this.scrollbarEl, hide: !0
        }
        );
        const e= {
            on:Object.assign( {}
    ...
    __stencil_render() {
        ...
        , s("slot", null)),
        this.pager&&s("div", {
            class: "swiper-pagination", ref: i=>this.paginationEl=i
        }
        ),
        this.scrollbar&&s("div", {
            class: "swiper-scrollbar", ref: i=>this.scrollbarEl=i
        }
        )]
    }
    ...
    render() {
        return s(n, this.hostData(), this.__stencil_render())
    }
    static get style() {
