...
export class ItemSliding {
    ...
    static get methods() { return {
        ...
        "close": {
            ...
            "docs": {
                "text": "Close the sliding item. Items can also be closed from the [List](../../list/List).",
                "tags": []
            }
        },
        "closeOpened": {
            ...
            "docs": {
                "text": "Close all of the sliding items in the list. Items can also be closed from the [List](../../list/List).",
                "tags": []
            }
        }
    }; }
