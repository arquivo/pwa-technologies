...
export class FabButton {
    ...
    render() {
        ...
        return (h(TagType, Object.assign({}, attrs, { class: "button-native", disabled: this.disabled, onFocus: this.onFocus, onBlur: this.onBlur, onClick: (ev) => openURL(this.href, ev, this.routerDirection) }),
