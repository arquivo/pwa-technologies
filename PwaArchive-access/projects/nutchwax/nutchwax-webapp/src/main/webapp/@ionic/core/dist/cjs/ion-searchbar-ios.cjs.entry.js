...
class Searchbar {
    constructor(hostRef) {
        ...
        this.ionClear = __chunk_1.createEvent(this, "ionClear", 7);
    ...
    positionPlaceholder() {
        ...
        if (this.shouldAlignLeft) {
            ...
            tempSpan.innerHTML = __chunk_8.sanitizeDOMString(this.placeholder) || '';
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, __chunk_5.createColorClasses(this.color), { [mode]: true, 'searchbar-animated': animated, 'searchbar-disabled': this.disabled, 'searchbar-no-animate': animated && this.noAnimate, 'searchbar-has-value': this.hasValue(), 'searchbar-left-aligned': this.shouldAlignLeft, 'searchbar-has-focus': this.focused, 'searchbar-should-show-cancel': this.shouldShowCancelButton() })
        };
    }
    __stencil_render() {
        const mode = __chunk_1.getIonMode(this);
        ...
        const cancelButton = !isCancelButtonSetToNever(this.showCancelButton) && (__chunk_1.h("button", { type: "button", tabIndex: mode === 'ios' && !this.shouldShowCancelButton() ? -1 : undefined, onMouseDown: this.onCancelSearchbar, onTouchStart: this.onCancelSearchbar, class: "searchbar-cancel-button" }, __chunk_1.h("div", null, mode === 'md'
            ? __chunk_1.h("ion-icon", { mode: mode, icon: this.cancelButtonIcon, lazy: false })
            : this.cancelButtonText)));
        return [
            __chunk_1.h("div", { class: "searchbar-input-container" }, __chunk_1.h("input", { disabled: this.disabled, ref: el => this.nativeInput = el, class: "searchbar-input", onInput: this.onInput, onBlur: this.onBlur, onFocus: this.onFocus, placeholder: this.placeholder, type: this.type, value: this.getValue(), autoComplete: this.autocomplete, autoCorrect: this.autocorrect, spellCheck: this.spellcheck }), mode === 'md' && cancelButton, __chunk_1.h("ion-icon", { mode: mode, icon: searchIcon, lazy: false, class: "searchbar-search-icon" }), __chunk_1.h("button", { type: "button", "no-blur": true, class: "searchbar-clear-button", onMouseDown: this.onClearInput, onTouchStart: this.onClearInput }, __chunk_1.h("ion-icon", { mode: mode, icon: clearIcon, lazy: false, class: "searchbar-clear-icon" }))),
