...
class VirtualScroll {
    ...
    updateVirtualScroll() {
        ...
        __chunk_1.readTask(this.readVS.bind(this));
        __chunk_1.writeTask(this.writeVS.bind(this));
    }
    readVS() {
    ...
    __stencil_render() {
        if (this.renderItem) {
            return (__chunk_1.h(VirtualProxy, { dom: this.virtualDom }, this.virtualDom.map(node => this.renderVirtualNode(node))));
        }
        return undefined;
    }
