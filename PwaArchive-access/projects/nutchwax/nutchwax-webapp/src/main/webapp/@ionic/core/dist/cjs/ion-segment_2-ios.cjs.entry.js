...
class Segment {
    ...
    hostData() {
        ...
        return {
            class: Object.assign({}, __chunk_5.createColorClasses(this.color), { [mode]: true, 'segment-disabled': this.disabled, 'segment-scrollable': this.scrollable })
        };
    }
...
class SegmentButton {
    ...
    render() {
        ...
        const mode = __chunk_1.getIonMode(this);
        return (__chunk_1.h(__chunk_1.Host, { onClick: this.onClick, "aria-disabled": disabled ? 'true' : null, class: {
                [mode]: true,
            ...
            } }, __chunk_1.h("button", { type: type, "aria-pressed": checked ? 'true' : null, class: "button-native", disabled: disabled }, __chunk_1.h("slot", null), mode === 'md' && __chunk_1.h("ion-ripple-effect", null)), __chunk_1.h("div", { class: "segment-button-indicator" })));
    }
    get el() { return __chunk_1.getElement(this); }
    static get watchers() { return {
