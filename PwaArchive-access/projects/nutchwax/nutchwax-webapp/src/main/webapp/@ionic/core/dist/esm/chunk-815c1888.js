...
const iosTransitionAnimation = () => import('./ios.transition-080db2c2.js');
const mdTransitionAnimation = () => import('./md.transition-9c1a17b7.js');
...
async function animation(animationBuilder, opts) {
    ...
    const trans = await import('./index-8ec7f6e0.js').then(mod => mod.create(animationBuilder, opts.baseEl, opts));
