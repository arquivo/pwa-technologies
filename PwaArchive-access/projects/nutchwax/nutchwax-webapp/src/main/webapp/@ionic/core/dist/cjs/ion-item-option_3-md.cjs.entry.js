...
class ItemOption {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { onClick: this.onClick, class: Object.assign({}, __chunk_5.createColorClasses(this.color), { [mode]: true, 'item-option-disabled': disabled, 'item-option-expandable': expandable, 'ion-activatable': true }) }, __chunk_1.h(TagType, Object.assign({}, attrs, { class: "button-native", disabled: disabled }), __chunk_1.h("span", { class: "button-inner" }, __chunk_1.h("slot", { name: "top" }), __chunk_1.h("div", { class: "horizontal-wrapper" }, __chunk_1.h("slot", { name: "start" }), __chunk_1.h("slot", { name: "icon-only" }), __chunk_1.h("slot", null), __chunk_1.h("slot", { name: "end" })), __chunk_1.h("slot", { name: "bottom" })), mode === 'md' && __chunk_1.h("ion-ripple-effect", null))));
    }
...
class ItemOptions {
    constructor(hostRef) {
         ...
         */
        this.side = 'end';
        this.ionSwipe = __chunk_1.createEvent(this, "ionSwipe", 7);
    }
    /** @internal */
    ...
    hostData() {
        const mode = __chunk_1.getIonMode(this);
        const isEnd = __chunk_7.isEndSide(this.side);
        return {
            class: {
                [mode]: true,
...
class ItemSliding {
    constructor(hostRef) {
         ...
         */
        this.disabled = false;
        this.ionDrag = __chunk_1.createEvent(this, "ionDrag", 7);
    }
    disabledChanged() {
        if (this.gesture) {
    ...
    async open(side) {
        ...
        side = __chunk_7.isEndSide(side) ? 'end' : 'start';
    ...
    async updateOptions() {
        ...
        for (let i = 0; i < options.length; i++) {
            ...
            const side = __chunk_7.isEndSide(option.side) ? 'end' : 'start';
            if (side === 'start') {
