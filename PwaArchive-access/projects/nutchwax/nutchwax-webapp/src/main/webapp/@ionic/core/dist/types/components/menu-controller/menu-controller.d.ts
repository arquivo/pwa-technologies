...
export declare class MenuController implements MenuControllerI {
     ...
     */
    enable(enable: boolean, menu?: string | null): Promise<HTMLIonMenuElement | undefined>;
    /**
     ...
     */
    swipeGesture(enable: boolean, menu?: string | null): Promise<HTMLIonMenuElement | undefined>;
    /**
