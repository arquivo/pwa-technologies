...
class ItemDivider {
    ...
    hostData() {
        const mode = __chunk_1.getIonMode(this);
        return {
            class: Object.assign({}, __chunk_5.createColorClasses(this.color), { [mode]: true, 'item-divider-sticky': this.sticky, 'item': true })
        };
    }
    __stencil_render() {
        return [
            __chunk_1.h("slot", { name: "start" }),
            __chunk_1.h("div", { class: "item-divider-inner" }, __chunk_1.h("div", { class: "item-divider-wrapper" }, __chunk_1.h("slot", null)), __chunk_1.h("slot", { name: "end" }))
        ];
    }
    get el() { return __chunk_1.getElement(this); }
...
class Label {
    ...
    hostData() {
        ...
        const mode = __chunk_1.getIonMode(this);
        return {
            class: Object.assign({}, __chunk_5.createColorClasses(this.color), { [mode]: true, [`label-${position}`]: position !== undefined, [`label-no-animate`]: (this.noAnimate) })
        };
    }
    get el() { return __chunk_1.getElement(this); }
...
class SkeletonText {
    ...
    hostData() {
        ...
        const inMedia = __chunk_5.hostContext('ion-avatar', this.el) || __chunk_5.hostContext('ion-thumbnail', this.el);
        const mode = __chunk_1.getIonMode(this);
