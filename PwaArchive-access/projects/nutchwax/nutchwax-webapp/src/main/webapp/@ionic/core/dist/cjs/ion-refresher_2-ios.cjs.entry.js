...
class Refresher {
    constructor(hostRef) {
         ...
         */
        this.disabled = false;
        this.ionRefresh = __chunk_1.createEvent(this, "ionRefresh", 7);
        this.ionPull = __chunk_1.createEvent(this, "ionPull", 7);
        this.ionStart = __chunk_1.createEvent(this, "ionStart", 7);
    }
    disabledChanged() {
        if (this.gesture) {
...
class RefresherContent {
    ...
    componentWillLoad() {
        if (this.pullingIcon === undefined) {
            this.pullingIcon = __chunk_2.config.get('refreshingIcon', 'arrow-down');
        }
        if (this.refreshingSpinner === undefined) {
            const mode = __chunk_1.getIonMode(this);
            this.refreshingSpinner = __chunk_2.config.get('refreshingSpinner', __chunk_2.config.get('spinner', mode === 'ios' ? 'lines' : 'crescent'));
        }
    }
    hostData() {
        const mode = __chunk_1.getIonMode(this);
    ...
    __stencil_render() {
        return [
            __chunk_1.h("div", { class: "refresher-pulling" }, this.pullingIcon &&
                __chunk_1.h("div", { class: "refresher-pulling-icon" }, __chunk_1.h("ion-icon", { icon: this.pullingIcon, lazy: false })), this.pullingText &&
                __chunk_1.h("div", { class: "refresher-pulling-text", innerHTML: __chunk_8.sanitizeDOMString(this.pullingText) })),
            __chunk_1.h("div", { class: "refresher-refreshing" }, this.refreshingSpinner &&
                __chunk_1.h("div", { class: "refresher-refreshing-icon" }, __chunk_1.h("ion-spinner", { name: this.refreshingSpinner })), this.refreshingText &&
                __chunk_1.h("div", { class: "refresher-refreshing-text", innerHTML: __chunk_8.sanitizeDOMString(this.refreshingText) }))
        ];
    }
