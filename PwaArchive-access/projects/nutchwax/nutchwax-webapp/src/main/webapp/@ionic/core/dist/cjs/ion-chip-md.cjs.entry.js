...
class Chip {
    ...
    hostData() {
        ...
        return {
            class: Object.assign({}, __chunk_5.createColorClasses(this.color), { [mode]: true, 'chip-outline': this.outline, 'ion-activatable': true })
        };
    }
    __stencil_render() {
        const mode = __chunk_1.getIonMode(this);
        return [
            ...
            mode === 'md' ? __chunk_1.h("ion-ripple-effect", null) : null
        ];
    }
