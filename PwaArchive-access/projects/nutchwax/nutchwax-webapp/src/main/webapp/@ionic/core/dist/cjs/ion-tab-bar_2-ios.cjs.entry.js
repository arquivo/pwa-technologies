...
class TabBar {
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, __chunk_5.createColorClasses(color), { [mode]: true, 'tab-bar-translucent': translucent, 'tab-bar-hidden': keyboardVisible })
        };
    }
    __stencil_render() {
...
class TabButton {
    ...
    componentWillLoad() {
        if (this.layout === undefined) {
            this.layout = __chunk_2.config.get('tabButtonLayout', 'icon-top');
        }
    }
    selectTab(ev) {
