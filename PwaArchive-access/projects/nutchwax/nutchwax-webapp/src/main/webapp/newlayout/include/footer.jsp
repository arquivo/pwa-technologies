<div id="footer">
	...
	<div id="empresa">
		<div class="wrap-footer">
			<a href="http://www.fccn.pt/" title="<fmt:message key='footer.sponsor.fccn'/>" ><img src="img/logo-fccn.gif" alt="<fmt:message key='footer.sponsor.fccn.alt'/>" width="182" height="46" id="fccn" /></a>&nbsp;
			<a href="http://www.mctes.pt/" title="<fmt:message key='footer.sponsor.mctes'/>"><img src="img/logo-mctes.gif" alt="<fmt:message key='footer.sponsor.mctes.alt'/>" width="125" height="19" /></a>&nbsp;
			<a href="http://www.umic.pt/" title="<fmt:message key='footer.sponsor.umic'/>"><img src="img/logo-umic.gif" alt="<fmt:message key='footer.sponsor.umic.alt'/>" width="57" height="29" /></a>&nbsp;
			<a href="http://v031.mm.fccn.pt/" title="<fmt:message key='footer.sponsor.posc'/>"><img src="img/logo-pos.gif" alt="<fmt:message key='footer.sponsor.posc.alt'/>" width="148" height="22" /></a>
		</div>
	</div>
</div>
