...
<div id="sponsor">
   ...
   <a href="http://www.min-edu.pt/"><img src="<%=footerPath%>/img/logo-mec.jpg" width="254" height="46" alt="<i18n:message key="sponsorMEC"/>" title="<i18n:message key="sponsorMEC"/>" /></a>
</div>
