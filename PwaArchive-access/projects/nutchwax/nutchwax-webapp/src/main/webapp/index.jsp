		...
		<div id="header-home">
						...
						<input type="hidden" name="l" value="<%= language %>" />
                                                <fieldset>
                                                        ...
                                                        <a href="advanced.jsp?l=<%=language%><%= request.getQueryString() != null ? "&" + request.getQueryString() : "" %>" onclick="ga('send', 'event', 'Homepage', 'pesquisa-avancada', 'Click on link (Pesquisa avancada)')" title="<fmt:message key='home.advanced.link.title'/>" id="pesquisa-avancada"><fmt:message key='home.advanced.link'/></a>
