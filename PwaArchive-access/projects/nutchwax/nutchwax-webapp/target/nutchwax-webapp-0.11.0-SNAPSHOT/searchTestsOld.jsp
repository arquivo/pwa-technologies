...
String banchor =  request.getParameter("banchor");
String bcontent =  request.getParameter("bcontent");
String btitle =  request.getParameter("btitle");
String bhost =  request.getParameter("bhost");
String bphrase =  request.getParameter("bphrase");
String bphraseslop =  request.getParameter("bphraseslop");

// if boost==-1 server should ignore
if (burl==null || burl.trim().equals("")) {
        burl= ""+nutchConf.getFloat("query.url.boost", 4.0f);
}
if (banchor==null || banchor.trim().equals("")) {
        banchor= ""+nutchConf.getFloat("query.anchor.boost", 2.0f);
}
if (bcontent==null || bcontent.trim().equals("")) {
        bcontent= ""+nutchConf.getFloat("query.content.boost", 1.0f);
}
if (btitle==null || btitle.trim().equals("")) {
        btitle= ""+nutchConf.getFloat("query.title.boost", 1.5f);
}
if (bhost==null || bhost.trim().equals("")) {
        bhost= ""+nutchConf.getFloat("query.host.boost", 2.0f);
}
if (bphrase==null || bphrase.trim().equals("")) {
        bphrase= ""+nutchConf.getFloat("query.phrase.boost", 1.0f);
}
if (bphraseslop==null || bphraseslop.trim().equals("")) {
        bphraseslop=""+3;
}

ArquivoWebWritable boostParams=new ArquivoWebWritable();
boostParams.setUrlBoost(Float.parseFloat(burl));
boostParams.setAnchorBoost(Float.parseFloat(banchor));
boostParams.setContentBoost(Float.parseFloat(bcontent));
boostParams.setTitleBoost(Float.parseFloat(btitle));
boostParams.setHostBoost(Float.parseFloat(bhost));
boostParams.setPhraseBoost(Float.parseFloat(bphrase));
boostParams.setSlop(Integer.parseInt(bphraseslop));
...
url: <%= nutchConf.getFloat("query.url.boost", 4.0f) %> 
<input name="burl" size=5 maxlength=5 value=<%= burl %>>
<br>
anchor: <%= nutchConf.getFloat("query.anchor.boost", 2.0f) %> 
<input name="banchor" size=5 maxlength=5 value=<%= banchor %>>
<br>
content: <%= nutchConf.getFloat("query.content.boost", 1.0f) %> 
<input name="bcontent" size=5 maxlength=5 value=<%= bcontent %>>
<br>
title: <%= nutchConf.getFloat("query.title.boost", 1.5f) %> 
<input name="btitle" size=5 maxlength=5 value=<%= btitle %>>
<br>
host: <%= nutchConf.getFloat("query.host.boost", 2.0f) %> 
<input name="bhost" size=5 maxlength=5 value=<%= bhost %>>
<br>
phrase: <%= nutchConf.getFloat("query.phrase.boost", 1.0f) %> 
<input name="bphrase" size=5 maxlength=5 value=<%= bphrase %>>
<br>
phrase slop: 3 (hard coded)  
<input name="bphraseslop" size=5 maxlength=5 value=<%= bphraseslop %>>
<br>
