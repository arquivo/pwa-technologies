...
public class TextSearchServlet extends HttpServlet {
    ...
    private static int nQueryMatchesReturned = 0;
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (limit > nQueryMatchesReturned)
            limit = nQueryMatchesReturned;
        ...
        if (metadataParam != null && !metadataParam.equals("")) { //metadata query
            ...
            if (hits != null && hits.getLength() > 0) {
                ...
                try {
                    ...
                    LOG.error("Got Summaries Error: ", e);
                }
            }

            itens = luceneQueryProcessor(length, fields, details, request.getParameter("details"), show, summaries, query);
            endTime = System.nanoTime();
            duration = (endTime - startTime);
        ...
        try {
		  ...
		  /*if( !siteParameter.equals( "" ) )
            ...
            if (collectionParameter != null && !collectionParameter.equals("")) {
                requestParameters.setCollection(collectionParameter);
            }
     ...
     * @return
     */
    private List<Item> luceneQueryProcessor(int length, String[] fields, HitDetails[] details, String detailsCheck, Hit[] show, Summary[] summaries, Query query) {
