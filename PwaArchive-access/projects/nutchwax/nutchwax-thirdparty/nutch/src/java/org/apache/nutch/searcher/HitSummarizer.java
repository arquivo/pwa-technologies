...
public interface HitSummarizer {
  ...
  /**
   * Returns summaries for a set of details, but only a request is made through hadoop
   *
   * @param summaries the details and query of hits to be summarized
   */
  Summary[] getSummary(PwaRequestSummaryWritable summaries) throws IOException;  
}
