...
public class Base32 {
    ...
    static public void main(String[] args) {
        ...
        /* TODO MC remove */
        try {
        	System.out.println("Base32 com Text >>>>");
        	MessageDigest md = MessageDigest.getInstance("MD5");
        	Text url=new Text("http://www.fccn.pt/index.php?amp;MMN_position=131:131&amp;PAGE_id=187&amp;PAGE_user_op=view_page&module=pagemaster");
        	System.out.println(Base32.encode(md.digest(url.toString().getBytes())));        	
        	url=new Text("http://www.fccn.pt/crc2005/datas.htm");
        	System.out.println(Base32.encode(md.digest(url.toString().getBytes())));
        }
        catch(Exception e){
        	e.printStackTrace();
