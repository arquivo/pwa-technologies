/* $Id: NutchwaxTest.java 1896 2007-08-01 21:44:31Z jlee-archive $
 *
 * Created Sep 5, 2006
 *
...
/**
 * @author stack
 * @version $Date: 2007-08-01 22:44:31 +0100 (Wed, 01 Aug 2007) $ $Version$
 */
public class NutchwaxTest extends TestCase
{
  public void testGetCollectionFromWaxKey() throws IOException
  {
    ...
    assertEquals(Nutchwax.getUrlFromWaxKey(new Text(key)), url);
  }
}